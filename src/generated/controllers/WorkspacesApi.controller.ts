...
export class WorkspacesApiController {
  ...
  addUserForWorkspace(@Param('workspace_gid') workspaceGid: string, @Body() addUserForWorkspaceRequest: AddUserForWorkspaceRequest, @Query('optPretty') optPretty: boolean, @Query('optFields') optFields: Array<'email' | 'name' | 'photo' | 'photo.image_1024x1024' | 'photo.image_128x128' | 'photo.image_21x21' | 'photo.image_27x27' | 'photo.image_36x36' | 'photo.image_60x60'>, @Req() request: Request): AddUserForWorkspace200Response | Promise<AddUserForWorkspace200Response> | Observable<AddUserForWorkspace200Response> {
  ...
  getWorkspace(@Param('workspace_gid') workspaceGid: string, @Query('optPretty') optPretty: boolean, @Query('optFields') optFields: Array<'email_domains' | 'is_organization' | 'name'>, @Req() request: Request): GetWorkspace200Response | Promise<GetWorkspace200Response> | Observable<GetWorkspace200Response> {
    return this.workspacesApi.getWorkspace(workspaceGid, optPretty, optFields, request);
  }

  @Get('/workspaces/:workspace_gid/events')
  getWorkspaceEvents(@Param('workspace_gid') workspaceGid: string, @Query('optPretty') optPretty: boolean, @Query('sync') sync: string, @Req() request: Request): GetEvents200Response | Promise<GetEvents200Response> | Observable<GetEvents200Response> {
  ...
  removeUserForWorkspace(@Param('workspace_gid') workspaceGid: string, @Body() removeUserForWorkspaceRequest: RemoveUserForWorkspaceRequest, @Query('optPretty') optPretty: boolean, @Req() request: Request): ApproveAccessRequest200Response | Promise<ApproveAccessRequest200Response> | Observable<ApproveAccessRequest200Response> {
