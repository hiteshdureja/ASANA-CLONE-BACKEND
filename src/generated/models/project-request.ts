...
export interface ProjectRequest { 
   ...
   */
  color?: ProjectRequest.ColorEnum | null;
  /**
   ...
   */
  default_view?: ProjectRequest.DefaultViewEnum;
  /**
   ...
   */
  privacy_setting?: ProjectRequest.PrivacySettingEnum;
  /**
   ...
   */
  default_access_level?: ProjectRequest.DefaultAccessLevelEnum;
  /**
   * The minimum access level needed for project members to modify this project\'s workflow and appearance.
   */
  minimum_access_level_for_customization?: ProjectRequest.MinimumAccessLevelForCustomizationEnum;
  /**
   * The minimum access level needed for project members to share the project and manage project memberships.
   */
  minimum_access_level_for_sharing?: ProjectRequest.MinimumAccessLevelForSharingEnum;
  /**
