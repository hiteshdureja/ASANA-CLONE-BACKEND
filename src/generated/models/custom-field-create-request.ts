...
export interface CustomFieldCreateRequest { 
   ...
   */
  readonly type?: CustomFieldCreateRequest.TypeEnum;
  /**
   ...
   */
  readonly representation_type?: CustomFieldCreateRequest.RepresentationTypeEnum;
  /**
   ...
   */
  format?: CustomFieldCreateRequest.FormatEnum;
  /**
   ...
   */
  custom_label_position?: CustomFieldCreateRequest.CustomLabelPositionEnum | null;
  /**
   ...
   */
  readonly asana_created_field?: CustomFieldCreateRequest.AsanaCreatedFieldEnum | null;
  /**
   ...
   */
  resource_subtype: CustomFieldCreateRequest.ResourceSubtypeEnum;
}
export namespace CustomFieldCreateRequest {
