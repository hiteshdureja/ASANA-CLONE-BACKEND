...
export interface ProjectBase { 
   ...
   */
  color?: ProjectBase.ColorEnum | null;
  /**
   ...
   */
  default_view?: ProjectBase.DefaultViewEnum;
  /**
   ...
   */
  privacy_setting?: ProjectBase.PrivacySettingEnum;
  /**
   ...
   */
  default_access_level?: ProjectBase.DefaultAccessLevelEnum;
  /**
   * The minimum access level needed for project members to modify this project\'s workflow and appearance.
   */
  minimum_access_level_for_customization?: ProjectBase.MinimumAccessLevelForCustomizationEnum;
  /**
   * The minimum access level needed for project members to share the project and manage project memberships.
   */
  minimum_access_level_for_sharing?: ProjectBase.MinimumAccessLevelForSharingEnum;
}
