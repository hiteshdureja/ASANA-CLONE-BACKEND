import { GoalRelationshipBaseAllOfSupportedGoal } from './goal-relationship-base-all-of-supported-goal';
...
export interface GoalRelationshipResponse { 
   ...
   */
  readonly resource_subtype?: GoalRelationshipResponse.ResourceSubtypeEnum;
...
export namespace GoalRelationshipResponse {
