...
export interface CustomFieldResponse { 
   ...
   */
  readonly type?: CustomFieldResponse.TypeEnum;
  /**
   ...
   */
  readonly representation_type?: CustomFieldResponse.RepresentationTypeEnum;
  /**
   ...
   */
  format?: CustomFieldResponse.FormatEnum;
  /**
   ...
   */
  custom_label_position?: CustomFieldResponse.CustomLabelPositionEnum | null;
  /**
   ...
   */
  readonly asana_created_field?: CustomFieldResponse.AsanaCreatedFieldEnum | null;
  /**
   ...
   */
  privacy_setting?: CustomFieldResponse.PrivacySettingEnum;
  /**
   ...
   */
  default_access_level?: CustomFieldResponse.DefaultAccessLevelEnum;
  /**
   * The type of the custom field. Must be one of the given values. 
   */
  readonly resource_subtype?: CustomFieldResponse.ResourceSubtypeEnum;
}
