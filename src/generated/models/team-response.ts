...
import { TeamResponseAllOfOrganization } from './team-response-all-of-organization';
...
export interface TeamResponse { 
   ...
   */
  visibility?: TeamResponse.VisibilityEnum;
  /**
   * Controls who can edit team name and description 
   */
  edit_team_name_or_description_access_level?: TeamResponse.EditTeamNameOrDescriptionAccessLevelEnum;
  /**
   * Controls who can edit team visibility and trash teams 
   */
  edit_team_visibility_or_trash_team_access_level?: TeamResponse.EditTeamVisibilityOrTrashTeamAccessLevelEnum;
  /**
   * Controls who can accept or deny member invites for a given team 
   */
  member_invite_management_access_level?: TeamResponse.MemberInviteManagementAccessLevelEnum;
  /**
   * Controls who can accept or deny guest invites for a given team 
   */
  guest_invite_management_access_level?: TeamResponse.GuestInviteManagementAccessLevelEnum;
  /**
   ...
   */
  join_request_management_access_level?: TeamResponse.JoinRequestManagementAccessLevelEnum;
  /**
   * Controls who can remove team members 
   */
  team_member_removal_access_level?: TeamResponse.TeamMemberRemovalAccessLevelEnum;
  /**
   * Controls who can create and share content with the team 
   */
  team_content_management_access_level?: TeamResponse.TeamContentManagementAccessLevelEnum;
  /**
