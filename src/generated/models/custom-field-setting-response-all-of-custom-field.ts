...
export interface CustomFieldSettingResponseAllOfCustomField { 
  /**
   ...
   */
  readonly type?: CustomFieldSettingResponseAllOfCustomField.TypeEnum;
  /**
   ...
   */
  readonly representation_type?: CustomFieldSettingResponseAllOfCustomField.RepresentationTypeEnum;
  /**
   ...
   */
  format?: CustomFieldSettingResponseAllOfCustomField.FormatEnum;
  /**
   ...
   */
  custom_label_position?: CustomFieldSettingResponseAllOfCustomField.CustomLabelPositionEnum | null;
  /**
   ...
   */
  readonly asana_created_field?: CustomFieldSettingResponseAllOfCustomField.AsanaCreatedFieldEnum | null;
  /**
   ...
   */
  privacy_setting?: CustomFieldSettingResponseAllOfCustomField.PrivacySettingEnum;
  /**
   ...
   */
  default_access_level?: CustomFieldSettingResponseAllOfCustomField.DefaultAccessLevelEnum;
  /**
   * The type of the custom field. Must be one of the given values. 
   */
  readonly resource_subtype?: CustomFieldSettingResponseAllOfCustomField.ResourceSubtypeEnum;
}
export namespace CustomFieldSettingResponseAllOfCustomField {
