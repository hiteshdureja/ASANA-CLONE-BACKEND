...
export interface CustomFieldBase { 
   ...
   */
  readonly type?: CustomFieldBase.TypeEnum;
  /**
   ...
   */
  readonly representation_type?: CustomFieldBase.RepresentationTypeEnum;
  /**
   ...
   */
  format?: CustomFieldBase.FormatEnum;
  /**
   ...
   */
  custom_label_position?: CustomFieldBase.CustomLabelPositionEnum | null;
  /**
   ...
   */
  readonly asana_created_field?: CustomFieldBase.AsanaCreatedFieldEnum | null;
}
